...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en" style="html{background:url('../img/splashpagebackground.jpg');background-image:url('/..img/splashpagebackground.jpg');} "> <!--<![endif]-->
<head>
  <meta charset="utf-8">
   ...
   <div style="background-image:url('../img/sleepsplashpagescaled2000.png');">
	   ...
	   <div id="main" class="wrapper" style="margin-top:0px;padding-top:0px;">
		   ...
		   <div id="splashLeftCol" >
			   ...
			   <a id="getYourCopyBtntrans" href="mp3s/Sleep - Redline.mp3"></a>
